...
<h1>Nuevo Inmueble Particular</h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="numeric" name="baños" class="form-control" id="baños" placeholder="baños..." value="{{ old('baños') }}" required>
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="habitaciones">Habitaciones</label>
                <input type="numeric" name="habitaciones" class="form-control" id="habitaciones" placeholder="habitaciones..." value="{{ old('habitaciones') }}" required>
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <label for="proyecto"> <b> El Apartamento pertenece a un Proyecto p Condominio?</b></label>
            <select class="grupo form-control" name="proyecto" id="proyecto">
                <option value="">Proyecto o condominio</option>
                @foreach ($proyectos as $proyecto)
                    <option id="{{$proyecto->id}}" data-proyecto-slug="{{$proyecto->descripcion}}" value="{{$proyecto->id}}">{{$proyecto->titulo}}</option>
                @endforeach
