...
<div class="container">
    <div class="card-header">
        ...
        @endif
        {{-- ////////////////////////////////////////////////////// --}}
        <form method="POST" action="/publicacions">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <select class="tipopublicacion_id form-control" name="tipopublicacion_id" id="tipopublicacion_id">
                    ...
                    <option data-tipopublicacion-id="{{$tipopublicacion->id}}" data-tipopublicacion-slug="{{$tipopublicacion->nombre}}" value="{{$tipopublicacion->id}}" >{{$tipopublicacion->nombre}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
            ...
            <input type="numeric" name="inmueble_id" id="inmueble_id" readonly="readonly" value="{{ $inmueble->id }}" hidden>
            <div class="form-group">
                <label for="precio">Precio:</label>
                <input type="decimal" name="precio" class="form-control" id="precio" placeholder="Precio($us)..." value="{{ old('precio') }}" >
            </div>
            <div class="form-group" id="div" style="display: none;"> <!--style="display: none;"<-->
                <label for="duracion">Duracion:</label>
                <input type="text" name="duracion" tag="duracion" class="form-control" id="duracion" placeholder="e.g. 1 año" value="{{old('duracion')}}" >
            </div>
            <div class="form-group pt-2">
                <input class="btn btn-success" type="submit" value="Publicar">
                <a  href="{{ route('inmuebles.index') }}" class="btn btn-danger">Cancelar</a>
            </div>
        </form>
        {{-- ////////////////////////////////////////////////////// --}}
        {{-- <p align="right">
