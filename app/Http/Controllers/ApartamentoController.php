...
class ApartamentoController extends Controller
{
    ...
    public function create()
    {
        ...
        // dd($proyectos);
        return view('inmueble.inmuebles.apartamento.create',['zonas'=>$zonas,'servicios'=>$servicios,'proyectos'=>$proyectos]);
    }
    ...
    public function edit(Inmueble $inmueble)
    {
        ...
        $proyectos=Inmueble::where('user_id',Auth::user()->id)->where('proyecto_id',null)->where('total_cupo','!=',null)->orderBy('id','desc')->get();
        // dd($proyectos);
        return view('inmueble.inmuebles.apartamento.edit',['zonas'=>$zonas,'servicios'=>$servicios,'proyectos'=>$proyectos]);
    }
