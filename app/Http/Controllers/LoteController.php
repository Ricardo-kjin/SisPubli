...
class LoteController extends Controller
{
    ...
    public function create()
    {
        ...
        // dd($proyectos);
        return view('inmueble.inmuebles.lote.create',['zonas'=>$zonas,'servicios'=>$servicios,'proyectos'=>$proyectos]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $tipoinm=TipoInmueble::where('nombre','like','%Lote%')->orwhere('nombre','like','%lote%')->get();
